...
from taac.testconfigs.snake.test_test_config import gen_snake_test_config
...
def test_config(topology: ConfigTopology):
    ...
    tgen_links = [l for l in topology.links if l.link_type == LinkType.TGEN]
    ...
    ixia_connections = [
        taac_types.DirectIxiaConnection(
            ...
            ixia_port=l.remote_port,
            ixia_chassis_ip=l.remote_host,
        )
        for l in tgen_links[:2]
    ]
