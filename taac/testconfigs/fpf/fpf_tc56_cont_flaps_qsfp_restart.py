...
"""TC56: TC40 rapid flaps plus graceful qsfp_service restarts.

All eight GTSWs run TC40's exact fail-closed 7s/7s flap contract for 30
minutes.  After flapping has been active for 10 minutes, qsfp_service is
gracefully restarted on every GTSW at 10-minute cadence, producing events at
approximately +10 and +20 minutes.  TC40's health checks, RDMA expectations,
strict failure verdicts, cleanup, and final 300-second stability soak are
unchanged.
"""
...
TEST_NAME = "fpf_tc56_cont_flaps_qsfp_restart"
