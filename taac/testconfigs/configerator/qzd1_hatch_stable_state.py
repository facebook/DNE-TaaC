...
def _disabled_cpu_traffic_items(port_a, port_b, port_c):
    return [
        ("RAW_BGP_R", port_a, port_b, BGP_CP_V6_GLOBAL_DSCP48_TRAFFIC_PACKET_HEADERS),
        ("RAW_BGP_B", port_b, port_c, BGP_CP_V6_GLOBAL_DSCP48_TRAFFIC_PACKET_HEADERS),
        ("RAW_BGP_U", port_c, port_a, BGP_CP_V6_GLOBAL_DSCP48_TRAFFIC_PACKET_HEADERS),
...
BLOCKED_TRAFFIC_ITEMS = BLOCKED_TCP_TRAFFIC_ITEMS + [
...
def _build_test_config(
    ...
    blocked = BLOCKED_TCP_TRAFFIC_ITEMS + [item[0] for item in raw_tcp_syn_items]
