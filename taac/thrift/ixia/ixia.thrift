// @generated SignedSource<<a8bfe866e29cee92ba05d27d4fda2c63>>
...
struct BgpPeerConfig {
  ...
  20: optional i32 tcp_window_size_bytes;
}
...
struct BgpPrefixConfig {
  ...
  17: optional SetNextHopType set_next_hop_type;
}
...
struct ImportBgpRoutesParams {
  ...
  15: optional string expected_content_sha256;
}
...
struct TransmissionControl {
  ...
  # The three below are used for BURST_FIXED_DURATION mode, which sends
  # bursts separated by an inter-burst gap for `duration` seconds. Optional
  # so an unset field leaves the IXIA default in place.
