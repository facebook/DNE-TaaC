...
class LegacyIxiaIdentitySidecar:
    ...
    def __post_init__(self) -> None:
        resource_ids = tuple(
            ...
            for identity in (*self.group_identities, *self.advertisement_identities)
        )
